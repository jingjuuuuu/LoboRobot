...
while True:
    try:
        ...
        print("offset = ", offset)
        ####小轉
        if x1 != -1 and s1 > -0.9 and s1 < -0.78 : # 左線斜率大於-0.6，要右轉
            print("小右轉")
            if x1 < 100:
                clbrobot.t_up(30, 1)
        ...
        elif x2 != -1 and s2 < 0.9 and s2 > 0.78: # 右線斜率小於0.6，要左轉
            print("小左轉")
            if x2 > 540:
                clbrobot.t_up(30, 1)
                ...
                clbrobot.turnLeft(30, 0.3)
            clbrobot.t_stop(0.15)
        if x1 != -1 and s1 > -0.78 and s1 < -0.45 : # 左線斜率大於-0.6，要右轉
            print("右轉")
            if x1 < 100:
                clbrobot.t_up(30, 1)
                ...
                clbrobot.turnRight(30, 0.45)
            clbrobot.t_stop(0.15)
        elif x2 != -1 and s2 < 0.78 and s2 > 0.45: # 右線斜率小於0.6，要左轉
            print("左轉")
            if x2 > 540:
                clbrobot.t_up(30, 1)
            ...
            clbrobot.t_stop(0.15)
        ####大轉
        elif x1 != -1 and s1 > -0.45:  # 左線斜率大於-0.4，要大右轉
            print("大右轉")
            if x1 < 100:
                ...
                clbrobot.turnRight(30, 0.6)
            clbrobot.t_stop(0.15)
        elif x2 != -1 and s2 < 0.45: # 右線斜率小於0.4，要大左轉
            print("大左轉")
            if x2 > 540:
                clbrobot.t_up(30, 0.95)
